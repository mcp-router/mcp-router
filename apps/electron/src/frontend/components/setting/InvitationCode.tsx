      ...
      <div className="space-y-4">
        ...
        {!isLoggedIn ? (
          <Alert className="bg-slate-50 dark:bg-slate-900">
            ...
            <AlertDescription>{t("invitation.pleaseLogin")}</AlertDescription>
          </Alert>
        ) : loading ? (
          ...
          <div className="space-y-2">
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <Badge
                  variant={
                    invitation.usedCount / invitation.maxUses >= 1
                      ? "default"
                      : "outline"
                  }
                  className={cn("transition-all", {
                    "border-border text-muted-foreground":
                      invitation.usedCount / invitation.maxUses <= 0.25,
                    "border-blue-200 text-blue-700 dark:border-blue-800 dark:text-blue-300":
                      invitation.usedCount / invitation.maxUses > 0.25 &&
                      invitation.usedCount / invitation.maxUses <= 0.5,
                    "border-indigo-200 text-indigo-700 dark:border-indigo-800 dark:text-indigo-300":
                      invitation.usedCount / invitation.maxUses > 0.5 &&
                      invitation.usedCount / invitation.maxUses <= 0.75,
              ...
              >
                <div
                  ...
                  style={{
                    width: `${(invitation.usedCount / invitation.maxUses) * 100}%`,
                  }}
                />
                {[...Array(5)].map(
                  (_, i) =>
