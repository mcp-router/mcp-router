...
priority: p3
issue_id: "093"
tags: ["simplicity", "backend"]
dependencies: []
---

# Over-engineered SingletonService Base Class



## Problem Statement

SingletonService is an over-engineered base class that forces subclasses to implement getEntityName() just for a generic error message.
...
apps/electron/src/main/modules/singleton-service.ts
