...
# Invisible Agent Features (Projects, Skills, Workflows)



## Problem Statement

The internal SystemServer completely omits tools for managing Projects, Skills, and Workflows. Agents cannot self-configure or build compound automations.
...
apps/electron/src/main/modules/system-server/system-server.ts lacks router_list_projects, router_create_skill, etc. router_add_server omits projectId.
