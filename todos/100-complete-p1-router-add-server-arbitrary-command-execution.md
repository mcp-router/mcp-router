...
**Notes:** Strengthened command validation to allowlist bare command names only and forced agent-created servers to manual start in /Users/robdezendorf/Documents/GitHub/mcp-router/apps/electron/src/main/modules/system-server/system-server.ts.
