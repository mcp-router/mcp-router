...
priority: p3
issue_id: "090"
tags: ["typescript", "frontend", "ipc"]
dependencies: []
---

# ContextBridge Type Degradation



## Problem Statement

Electron preload.ts ContextBridge exposes functions relying heavily on any for incoming shapes.
