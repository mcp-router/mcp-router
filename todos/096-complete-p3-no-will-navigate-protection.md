...
# No will-navigate Protection for the Main Window



## Problem Statement

Electron app does not prevent the main window from being navigated to an external URL, allowing potential XSS to bypass local CSP.
...
apps/electron/src/main.ts lacks a will-navigate event listener.
...
**Notes:** Added will-navigate protection that blocks in-window navigation and only opens external http(s) URLs in /Users/robdezendorf/Documents/GitHub/mcp-router/apps/electron/src/main.ts.
