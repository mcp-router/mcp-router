...
# Non-null Assertions (!.) Missing Guaranteed Initializers



## Problem Statement

Explicit non-null assertions like this.metaDb!.prepare(...) assume connection is synced. If it fails, hits unhandled TypeError.
