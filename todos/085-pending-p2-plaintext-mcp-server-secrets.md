...
# Plaintext Storage of MCP Server Secrets in SQLite



## Problem Statement

MCP Server configurations (bearer_token, API Keys) are stored in plaintext inside the mcprouter.db instead of using safeStorage.
