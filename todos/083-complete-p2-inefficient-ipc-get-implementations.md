...
priority: p2
issue_id: "083"
tags: ["performance", "frontend", "ipc"]
dependencies: []
---

# Inefficient IPC get Implementations



## Problem Statement

ElectronPlatformAPI implements get(id) methods by fetching the entire list of items over IPC and then finding the item on the client side.
