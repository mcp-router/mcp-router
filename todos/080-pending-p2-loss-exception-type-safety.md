...
# Loss of Exception Type Safety (catch (error: any))



## Problem Statement

Widespread use of any in try...catch blocks. Bypassing unknown makes error.message silently succeed in the compiler but potentially crash at runtime.
...
apps/cli/src/commands/connect.ts and apps/electron/src/renderer/components/client-apps/ClientApps.tsx
