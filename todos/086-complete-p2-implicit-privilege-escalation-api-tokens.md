...
# Implicit Privilege Escalation for Existing API Tokens



## Problem Statement

When a new MCP server is added, the app explicitly grants all existing API tokens access to it. Untrusted clients implicitly gain full access.
...
addServer() in apps/electron/src/main/modules/mcp-server-manager/server-service.ts
...
**Notes:** Removed implicit token auto-grants for new servers and restricted token sync to stale-access pruning in /Users/robdezendorf/Documents/GitHub/mcp-router/apps/electron/src/main/modules/mcp-server-manager/server-service.ts and /Users/robdezendorf/Documents/GitHub/mcp-router/apps/electron/src/main/infrastructure/shared-config-manager.ts.
