...
# Redundant State Refetches in Zustand Stores



## Problem Statement

Mutations update local state and then immediately call refreshServers() fetching the entire list over IPC again.
...
apps/electron/src/renderer/stores/server-store.ts
