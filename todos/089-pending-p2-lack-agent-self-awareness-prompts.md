...
# Lack of Agent Self-Awareness Context (Prompts API)



## Problem Statement

mcp-router does not provide connecting agents with inherent context about its environment via Prompts API.
...
system-server.ts does not implement standard MCP prompts/list or prompts/get endpoints.
