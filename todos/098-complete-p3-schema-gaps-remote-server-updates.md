...
priority: p3
issue_id: "098"
tags: ["agent-native", "backend"]
dependencies: []
---

# Schema Gaps in Remote Server Updates



## Problem Statement

router_update_server tool schema lacks remoteUrl, bearerToken, and description, forcing agents to delete and recreate remote servers.
...
system-server.ts router_update_server inputSchema
...
**Notes:** Expanded router_update_server runtime validation + schema parity to include remoteUrl/bearerToken/description in /Users/robdezendorf/Documents/GitHub/mcp-router/apps/electron/src/main/modules/system-server/system-server.ts and /Users/robdezendorf/Documents/GitHub/mcp-router/apps/electron/src/main/modules/system-server/system-server.types.ts.
