...
# Incomplete Workspace Parity



## Problem Statement

Agents can list/switch workspaces but cannot create, modify, delete, or fetch credentials for them.
...
SystemServer only exports list/switch. workspace.ipc.ts provides complete capabilities.
