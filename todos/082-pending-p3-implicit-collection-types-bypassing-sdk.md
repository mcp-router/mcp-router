...
# Implicit Collection Types Bypassing MCP SDK



## Problem Statement

The CLI aggregator layer fetches core MCP concepts but returns Promise<any[]> instead of honoring the strict SDK models.
...
apps/cli/src/mcp-aggregator.ts aggregateTools()
