...
priority: p3
issue_id: "097"
tags: ["security", "backend", "ipc"]
dependencies: []
---

# Lack of Strict Runtime Schema Validation on IPC Input



## Problem Statement

IPC handlers trust incoming Typescript declarations without runtime validation (Zod). Can lead to XSS/Path Traversal exploits.
