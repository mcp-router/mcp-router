...
# Arbitrary Directory Deletion via Path Traversal in Workspace Deletion



## Problem Statement

The workspace:create IPC handler accepts a user-provided config.id which is directly used to construct the local SQLite databasePath without validation. Deletion uses fs.rm recursively.
...
Found in apps/electron/src/main/modules/workspace/workspace.service.ts. An attacker could pass a malicious ID like ../../../../ to delete arbitrary directories.
...
**Notes:** Added workspace ID validation and safe delete-path boundary checks in /Users/robdezendorf/Documents/GitHub/mcp-router/apps/electron/src/main/modules/workspace/workspace.service.ts.
