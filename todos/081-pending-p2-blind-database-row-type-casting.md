...
priority: p2
issue_id: "081"
tags: ["typescript", "database", "backend"]
dependencies: []
---

# Blind Database Row Type Casting



## Problem Statement

SQLite repositories retrieve rows using any and blindly cast them to TypeScript literals/unions. BaseRepository accepts options: any.
...
apps/electron/src/main/modules/skills/client-skill-state.repository.ts and base-repository.ts.
