...
**Notes:** Patched MCPB install path to enforce pre-read size checks and non-blocking async read in /Users/robdezendorf/Documents/GitHub/mcp-router/apps/electron/src/main/modules/system-server/system-server.ts.
