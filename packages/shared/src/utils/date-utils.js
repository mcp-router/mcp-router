 ...
 * i18nを使用して時間をフォーマット
 */
export function formatDateI18n(date, t, formatKey = "shortDateTime") {
  const instance = getDateInstance(date);
 ...
 */
export function generateBuckets(startDate, endDate) {
 ...
 */
export function parseHourBucket(hourBucket) {
  return dayjs.tz(
    `${hourBucket}:00:00`,
    "YYYY-MM-DD HH:mm:ss",
    DEFAULT_TIMEZONE,
